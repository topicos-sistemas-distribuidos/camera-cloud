...
import br.ufc.great.offloadmyphotos.dao.ResultDao;
import br.ufc.great.offloadmyphotos.dao.model.AppConfiguration;
import br.ufc.great.offloadmyphotos.dao.model.ResultImage;
import br.ufc.great.offloadmyphotos.util.ImageUtils;
import br.ufc.great.offloadmyphotos.util.TaskResultAdapter;
...
public final class ImageFilterTask extends AsyncTask<Void, String, ResultImage> {
	...
	public ImageFilterTask(Context context, IImageFilter filter, AppConfiguration config, TaskResultAdapter<ResultImage> taskResult) {
